...
const routes = [
    ...
    { path: 'details', component: _ticket_details_ticket_details_component__WEBPACK_IMPORTED_MODULE_6__["TicketDetailsComponent"] },
];
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _ticket_details_ticket_details_component__WEBPACK_IMPORTED_MODULE_6__["TicketDetailsComponent"]
        ],
        imports: [
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
            _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forRoot(routes)
        ],
        providers: [_backend_service__WEBPACK_IMPORTED_MODULE_4__["BackendService"]],
...
let BackendService = class BackendService {
    ...
    tickets() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(this.storedTickets).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["delay"])(randomDelay()));
    }
    ticket(id) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(this.findTicketById(id)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["delay"])(randomDelay()));
    }
    users() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(this.storedUsers).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["delay"])(randomDelay()));
    }
    user(id) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(this.findUserById(id)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["delay"])(randomDelay()));
    }
    newTicket(payload) {
        const newTicket = {
            id: ++this.lastId,
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(newTicket).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["delay"])(randomDelay()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((ticket) => this.storedTickets.push(ticket)));
    }
    assign(ticketId, userId) {
        const foundTicket = this.findTicketById(+ticketId);
        const user = this.findUserById(+userId);
        if (foundTicket && user) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(foundTicket).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["delay"])(randomDelay()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((ticket) => {
                ticket.assigneeId = +userId;
            }));
        }
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(new Error('ticket or user not found'));
    }
    complete(ticketId, completed) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(new Error('ticket not found'));
    }
};
...
/***/ "./src/app/ticket-details/ticket-details.component.css":
/*!*************************************************************!*\
  !*** ./src/app/ticket-details/ticket-details.component.css ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJ0aWNrZXQtZGV0YWlscy90aWNrZXQtZGV0YWlscy5jb21wb25lbnQuY3NzIn0= */"
...
TicketDetailsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [__webpack_require__(/*! ./ticket-details.component.css */ "./src/app/ticket-details/ticket-details.component.css")]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJ0aWNrZXQvdGlja2V0LmNvbXBvbmVudC5jc3MifQ== */"
...
module.exports = "<a routerLink=\"details\" routerLinkActive=\"active\" >Ticket: {{t.id}}, {{t.description}}</a>"
...
module.exports = __webpack_require__(/*! /Users/yallen/Documents/angular_projects/nrwl-coding-assignment-2018-g9qwaz/src/main.ts */"./src/main.ts");
